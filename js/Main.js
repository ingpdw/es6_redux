...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _jsNamespacer = __webpack_require__(32);
	
	var _jsNamespacer2 = _interopRequireDefault(_jsNamespacer);
	...
	(function ($, window) {
	  ...
	  (0, _jsNamespacer2.default)(window, 'my.Project');
	  window.my.Project = _Main2.default;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Increment = __webpack_require__(2);
	
	var _Increment2 = _interopRequireDefault(_Increment);
	
	var _Decrement = __webpack_require__(28);
	
	var _Decrement2 = _interopRequireDefault(_Decrement);
	
	var _SetCount = __webpack_require__(29);
	
	var _SetCount2 = _interopRequireDefault(_SetCount);
	
	var _ButtonCount = __webpack_require__(30);
	
	var _ButtonCount2 = _interopRequireDefault(_ButtonCount);
	
	var _DisplayCount = __webpack_require__(31);
	
	var _DisplayCount2 = _interopRequireDefault(_DisplayCount);
	...
	var Main = function () {
	  ...
	  _createClass(Main, [{
	    key: 'init',
	    value: function init() {
	      var increment = new _Increment2.default();
	      var decrement = new _Decrement2.default();
	      var setCount = new _SetCount2.default();
	      var buttonCount = new _ButtonCount2.default();
	      var displayCount = new _DisplayCount2.default();
	    }
	  }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Increment = function () {
	  ...
	  _createClass(Increment, [{
	    ...
	    key: 'template',
	    value: function template(selector) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var initialButtonCount = 10;
	
	function myCount() {
	  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialCountState;
	  var action = arguments[1];
	...
	function buttonCount() {
	  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : initialButtonCount;
	  var action = arguments[1];
	
	  switch (action.type) {
	    case _actions.SET_BUTTON_COUNT:
	...
	var reducer = (0, _redux.combineReducers)({ myCount: myCount, buttonCount: buttonCount });
...
/***/ (function(module, exports) {
	...
	exports.setCountAction = setCountAction;
	exports.setButtonCountAction = setButtonCountAction;
	...
	var SET_BUTTON_COUNT = exports.SET_BUTTON_COUNT = 'SET_BUTTON_COUNT';
	...
	function setCountAction(count) {
	  return { type: SET_COUNT, count: count };
	}
	
	function setButtonCountAction(count) {
	  return { type: SET_BUTTON_COUNT, count: count };
	}
	...
	var Decrement = function () {
	  ...
	  _createClass(Decrement, [{
	    ...
	    value: function init() {
	      ...
	      $body.on('click', '#' + this.selector, function () {
	        //@dispatch
	        _Store2.default.dispatch((0, _actions.decrementAction)());
	      });
	    }
	  }, {
	    key: 'template',
	...
	var SetCount = function () {
	  ...
	  _createClass(SetCount, [{
	    ...
	    value: function init() {
	      ...
	      $body.on('click', '#' + this.selector, function () {
	        //@dispatch
	        _Store2.default.dispatch((0, _actions.setCountAction)(_this.count));
	      });
	    }
	  }, {
	    key: 'subscribe',
	...
	var ButtonCount = function () {
	  ...
	  _createClass(ButtonCount, [{
	    ...
	    value: function init() {
	      var $body = jQuery('body');
	      $body.append(this.template());
	      $body.on('keyup', '#' + this.selector, function (evt) {
	        var $this = jQuery(evt.target);
	        var val = $this.val().replace(/\s/g, '');
	        //@dispatch
	        _Store2.default.dispatch((0, _actions.setButtonCountAction)(!isNaN(val) && val ? evt.target.value : 0));
	      });
	    }
	  }, {
	    key: 'template',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var DisplayCount = function () {
	  ...
	  _createClass(DisplayCount, [{
	    ...
	    key: 'template',
	    value: function template() {
	      return '<span id="' + this.selector + '">' + _Store2.default.getState().myCount.count + '</span>';
	    }
	  }]);
